...
func (r *Repository) GetRoadInfoForAssetMap(roadID int) ([]models.RoadReportInfo, error) {
...
func (r *Repository) GetTableNameForAssetMap(roadID, assetID string) (*models.TableName, error) {
...
func (r *Repository) GetColumnForAssetMap(assetID, typ string) ([]models.Column, error) {
...
func (r *Repository) GetAssetNameForAssetMap(assetID string) (*models.AssetName, error) {
...
func (r *Repository) GetRowForAssetMap(columnName []string, roadID, assetID, tableName, join, typ string) ([]map[string]interface{}, error) {
...
func (r *Repository) GetRoadGeomForAssetMap(roadID string) ([]models.MapGeom, error) {
...
func (r *Repository) GetMapGeomForAssetMap(roadID, assetID, tableName, typ string) ([]models.MapGeom, error) {
	var resp []models.MapGeom
	where := "is_visible_report"
	if typ == "excel" {
		where = "is_visible_view"
