...
// Todo ...
type MaintenanceRoadHistory struct {
	ID                           int       `json:"id"`             // รหัส
...
type MaintenanceRoadHistoryData struct {
	...
	Attacchments                 []MaintenanceRoadHistoryAttachment `json:"attacchments" gorm:"ForeignKey:MaintenanceRoadHisID;AssociationForeignKey:ID"`
}
...
type MaintenanceRoadHistoryPreloadByID struct {
	ID                           int                                    `json:"id"` // รหัส
	IDParent                     int                                    `json:"id_parent"`
	MaintenanceID                int                                    `json:"-"`      // รหัสโครงการ
	Status                       string                                 `json:"status"` // สถานะ
	...
	Attachments                  []MaintenanceRoadHistoryAttachmentData `json:"attachments" gorm:"ForeignKey:MaintenanceRoadHistoryID;AssociationForeignKey:ID"`
}

func (b *MaintenanceRoadHistory) TableName() string {
	return "maintenance_road_history"
}

func (b *MaintenanceRoadHistoryData) TableName() string {
	return "maintenance_road_history"
}

func (b *MaintenanceRoadHistoryPreload) TableName() string {
	return "maintenance_road_history"
}

func (b *MaintenanceRoadHistoryPreloadByID) TableName() string {
	return "maintenance_road_history"
}
