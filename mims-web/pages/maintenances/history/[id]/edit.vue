...
import { MaintenanceHistoryEdit } from "~/core/modules/maintenance/history/ui"
...
useHead({
	title: "แก้ไขประวัติการซ่อมบำรุง",
})
...
<template>
	<div class="row mb-3">
		...
		<div class="col-auto d-flex align-self-end" style="margin-top: 0.7em">
			<TheBreadcrumb :breadcrumbs="[{ name: 'ประวัติการซ่อมบำรุง' }]" title="แก้ไขประวัติการซ่อมบำรุง" />
		</div>
	</div>
