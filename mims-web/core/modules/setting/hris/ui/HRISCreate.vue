...
import { useHRISCreateStore } from "../store"
...
const store = useHRISCreateStore()
					...
					<div class="modal-body">
						<div class="row">
							<div class="col-6 mb-5">
								<VTextInput
									v-model="store.params.road_number"
									name="road_number"
									label="รหัสสายทาง"
							...
							<div class="col-6 mb-5">
								<VTextInput
									v-model="store.params.section_road_number"
									label="รหัสตอนควบคุม"
						...
						<div class="row">
							<div class="col-6 mb-5">
								<VTextInput
									v-model="store.params.office_of_highways_code"
									label="รหัสสำนักงาน"
