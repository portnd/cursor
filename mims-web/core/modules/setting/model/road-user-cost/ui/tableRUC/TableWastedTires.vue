			...
			<div class="col-12 mb-5">
				<div class="table-responsive">
					<table class="table customize-basic-table mb-0">
						<thead>
							<tr>
								<th width="20%" class="text-center fw-semibold">ชื่อ</th>
								<th class="text-center fw-semibold">C0TC <span class="required"></span></th>
								<th class="text-center fw-semibold">CTCTE <span class="required"></span></th>
								<th class="text-center fw-semibold">VOL <span class="required"></span></th>
							</tr>
						</thead>
						<tbody v-for="(item, name, index) in rucStore.rucData" :key="index">
							<tr>
								...
								<td><VNumberInput v-model="item.c0_tc" :name="`c0_tc_${index}`" :precision="5" /></td>
								<td><VNumberInput v-model="item.ct_cte" :name="`ct_cte_${index}`" :precision="5" /></td>
								<td><VNumberInput v-model="item.vol" :name="`vol_${index}`" :precision="5" /></td>
							</tr>
						</tbody>
					</table>
				</div>
