					...
					<table class="table customize-basic-table mb-0">
						<thead>
							<tr>
								...
								<th style="width: 130px" class="text-center fw-semibold">cr_a1 <span class="required"></span></th>
								<th style="width: 130px" class="text-center fw-semibold">cr_a2 <span class="required"></span></th>
								<th style="width: 130px" class="text-center fw-semibold">p <span class="required"></span></th>
								<th style="width: 130px" class="text-center fw-semibold">CD <span class="required"></span></th>
								<th style="width: 130px" class="text-center fw-semibold">CDMUL <span class="required"></span></th>
								<th style="width: 130px" class="text-center fw-semibold">Af <span class="required"></span></th>
							</tr>
						</thead>
						<tbody v-for="(item, name, index) in rucStore.rucData" :key="index">
							<tr>
								...
								<td><VNumberInput v-model="item.cr_a1" :name="`cr_a1_${index}`" :precision="5" /></td>
								<td><VNumberInput v-model="item.cr_a2" :name="`cr_a2_${index}`" :precision="5" /></td>
								<td><VNumberInput v-model="item.p" :name="`p_${index}`" :precision="5" /></td>
								<td><VNumberInput v-model="item.cd" :name="`cd_${index}`" :precision="5" /></td>
								<td><VNumberInput v-model="item.cdmul" :name="`cdmul_${index}`" :precision="5" /></td>
								<td><VNumberInput v-model="item.af" :name="`af_${index}`" :precision="5" /></td>
							</tr>
						</tbody>
					</table>
				</div>
