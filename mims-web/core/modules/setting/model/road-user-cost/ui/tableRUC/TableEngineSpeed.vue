			...
			<div class="col-12 mb-5">
				<div class="table-responsive">
					<table class="table customize-basic-table mb-0">
						<thead>
							<tr>
								<th style="width: 150px" class="text-center fw-semibold">ชื่อ</th>
								<th style="width: 150px" class="text-center fw-semibold">RPM_A0 <span class="required"></span></th>
								<th style="width: 150px" class="text-center fw-semibold">RPM_A1 <span class="required"></span></th>
								<th style="width: 150px" class="text-center fw-semibold">RPM_A2 <span class="required"></span></th>
								<th style="width: 150px" class="text-center fw-semibold">RPM_IDLE <span class="required"></span></th>
								<th style="width: 150px" class="text-center fw-semibold">RPM_100 <span class="required"></span></th>
							</tr>
						</thead>
						<tbody v-for="(item, name, index) in rucStore.rucData" :key="index">
							<tr>
								...
								<td><VNumberInput v-model="item.rpm_a0" :name="`rpm_a0_${index}`" :precision="4" /></td>
								<td><VNumberInput v-model="item.rpm_a1" :name="`rpm_a1_${index}`" :precision="4" /></td>
								<td><VNumberInput v-model="item.rpm_a2" :name="`rpm_a2_${index}`" :precision="4" /></td>
								<td><VNumberInput v-model="item.rpm_idle" :name="`rpm_idle_${index}`" :precision="4" /></td>
								<td><VNumberInput v-model="item.rpm100" :name="`rpm100_${index}`" :precision="4" /></td>
							</tr>
						</tbody>
					</table>
				</div>
