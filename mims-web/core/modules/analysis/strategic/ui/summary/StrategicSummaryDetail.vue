...
import { useStrategicDetailsStore } from "../../store"
...
const store = useStrategicDetailsStore()
			...
			<div class="card p-5 mb-5">
				<div class="row mb-md-5">
					...
					<div class="col-tool d-flex gap-2 align-items-end my-2">
						...
						<NuxtLink
							class="btn btn-outline btn-outline-primary rounded-4"
