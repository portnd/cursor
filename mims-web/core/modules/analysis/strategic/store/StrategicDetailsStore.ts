...
interface IState {
	...
	data: IStrategicAnalyzeData
	roadGroup: IStrategicRoadGroup[]
	intervention_criteria: IStrategicInterventionCriteria[]
	params: IStateParams
	update_params: IUpdateModelReq[]
}

export const useStrategicDetailsStore = defineStore("strategic/details", {
	state: (): IState => ({
		loading: false,
		submit_loading: false,
		search_loading: false,
		data: {} as IStrategicAnalyzeData,
		roadGroup: [],
