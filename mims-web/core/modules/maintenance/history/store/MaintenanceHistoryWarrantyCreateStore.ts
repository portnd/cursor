...
export const useMaintenanceWarrantyCreateStore = defineStore("maintenance-history/warranty/create", {
	state: (): IState => ({
		loading: false,
		submitLoading: false,
		roadOptions: [],
	...
	actions: {
		...
		async createMaintenanceWarrantyInfo(id: number) {
			...
			const service = new MaintenanceHistoryService()
			const res = await service.createMaintenanceWarranty(id, params)
