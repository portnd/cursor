    ...
    >
      ...
      <nav class="flex-1 p-3 space-y-1 overflow-hidden">
        ...
        <NuxtLink
          ...
          class="nav-link"
          active-class="bg-gradient-to-r from-purple-600 to-pink-600 shadow-lg"
          :title="sidebarCollapsed ? 'Gantt Timeline' : undefined"
        >
          <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /></svg>
          <span v-show="!sidebarCollapsed" class="font-medium truncate">Gantt Timeline</span>
        </NuxtLink>
        <NuxtLink
          ...
          class="nav-link"
          active-class="bg-gradient-to-r from-purple-600 to-pink-600 shadow-lg"
          :title="sidebarCollapsed ? 'Team Roster' : undefined"
        >
          <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" /></svg>
          <span v-show="!sidebarCollapsed" class="font-medium truncate">👑 Team Roster</span>
        </NuxtLink>
        <NuxtLink
          v-if="currentUser?.role === 'CEO'"
        ...
        >
          ...
          <span v-show="!sidebarCollapsed" class="font-medium truncate">⚙️ AI Control Tower</span>
        </NuxtLink>
      </nav>

      <!-- User + Logout + Toggle hint -->
      <div class="p-3 border-t border-gray-700 space-y-1">
        <div class="flex items-center gap-3 px-3 py-2.5 bg-gray-700/50 rounded-lg overflow-hidden">
