          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div class="space-y-4">
              ...
              <div class="rounded-2xl border border-gray-700/60 bg-gray-800/30 p-4 flex gap-2">
                <button class="flex-1 text-xs py-2 rounded-lg text-gray-400 border border-gray-700 hover:bg-gray-700/50 hover:text-white transition-colors" @click="activeTab = 'salaries'">
                  Edit Salaries →
                </button>
                <button class="flex-1 text-xs py-2 rounded-lg text-gray-400 border border-gray-700 hover:bg-gray-700/50 hover:text-white transition-colors" @click="activeTab = 'config'">
                  Edit Config →
                </button>
              </div>
            </div>
                ...
                <div class="flex items-center justify-between px-5 py-3 bg-gray-900 border-b border-gray-800 flex-shrink-0">
                  ...
                  <div class="flex items-center gap-2">
                    ...
                    <button
                      ...
                      class="flex items-center gap-2 px-4 py-2 rounded-lg bg-blue-600 hover:bg-blue-500 text-white text-sm font-bold transition-colors shadow-lg shadow-blue-500/20"
                    >
                    ...
                    <button
                      ...
                      class="flex items-center gap-2 px-3 py-2 rounded-lg bg-gray-800 hover:bg-gray-700 text-gray-300 hover:text-white text-sm font-semibold transition-colors border border-gray-700"
                    >
                      <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
