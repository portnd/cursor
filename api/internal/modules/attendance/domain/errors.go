...
var (
	...
	ErrOffsiteReasonRequired            = errors.New("offsite check-in reason is required")
	ErrOffsiteAlreadyRequested          = errors.New("offsite check-in request already submitted for today")
	ErrOffsiteRequestNotFound           = errors.New("offsite check-in request not found")
	ErrOffsiteRequestNotPending         = errors.New("offsite check-in request is already reviewed")
	ErrOffsiteApprovalNotRequired       = errors.New("you are inside office radius, use normal check-in")
	ErrOffsiteWFHNotAllowed             = errors.New("today is a WFH day, use normal check-in")
	ErrForbiddenCEOOnly                 = errors.New("forbidden: CEO only")
	ErrOffsiteCheckOutReasonRequired    = errors.New("offsite check-out reason is required")
	ErrOffsiteCheckOutAlreadyRequested  = errors.New("offsite check-out request already submitted for today")
	ErrOffsiteCheckOutRequestNotFound   = errors.New("offsite check-out request not found")
	ErrOffsiteCheckOutRequestNotPending = errors.New("offsite check-out request is already reviewed")
)
